...
def mine_block():
    ...
    blockchain.add_transaction(sender=node_address, receiver='Gift', amount=1)
...
def connect_node():
    ...
    response = {
        'message': 'All the nodes are now connected. The Giftcoin Blockchain now contains the following nodes:',
